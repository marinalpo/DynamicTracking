...
from TrackerDyn_all_distances import TrackerDyn_all_distances
...
tracker_gt = TrackerDyn_all_distances(T0=T0, noise=eps, metric=metric, not_GT=False)
tracker_pred = TrackerDyn_all_distances(T0=T0, W=W, noise=eps, metric=metric)
...
t = 37
x_bef = tracker_pred.buffer_centr
x_bef = x_bef[t - T0:t, 0]
print(x_bef)
# Scores
...
# savemat('/Users/marinaalonsopoal/Documents/MATLAB/AR_Models/data/centroids_'+str(obj)+'_gt.mat', {'data': centroids_gt})
# savemat('/Users/marinaalonsopoal/Documents/MATLAB/AR_Models/data/centroids_'+str(obj)+'.mat', {'data': centroids})
