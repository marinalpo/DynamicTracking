...
if __name__ == '__main__':
            ...
            for key, value in objects.items():
                ...
                if correct_with_dynamics:
                    ...
                    if c[0] or c[1]:
                        ...
                        location_siam = np.int0(rboxes[idx][0].flatten()).reshape((-1, 1, 2))
                        if draw_corrected:
                            cv2.polylines(im, [location_siam], True, (0, 255, 255), 3)
    ...
    if single_object and correct_with_dynamics:
        print('Object Tracked:', str(obj), ' N:', str(N), 'Filter Boxes:', filter_boxes)
